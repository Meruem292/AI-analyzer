...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M6 5v0a3 3 0 1 1 5.993.142" />
    <path d="M12 12v0a3 3 0 1 1 5.993.142" />
    <path d="M6 12v0a3 3 0 1 1 5.993.142" />
    <path d="M12 19v0a3 3 0 1 1 5.993.142" />
    <path d="M6 19v0a3 3 0 1 1 5.993.142" />
    <path d="M9 7.5a2.5 2.5 0 0 1 0 5" />
    <path d="M15 7.5a2.5 2.5 0 0 0 0 5" />
    <path d="M9 14.5a2.5 2.5 0 0 1 0 5" />
    <path d="M15 14.5a2.5 2.5 0 0 0 0 5" />
  </svg>
);
